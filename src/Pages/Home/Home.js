...
import AlbumCardComponent from "./../../Components/AlbumCardComponent/index";
  ...
  return (
    <BFooter text="muted">
      <Container>
        ...
        <p>Album example is &copy; customize it for yourself!</p>
        <p>New to Site? <a href="../../">Visit the homepage</a> or read our <a href="../../getting-started/">getting started guide</a>.</p>
      </Container>
    </BFooter>
  )
}
...
export default function App(item) {
  ...
  const { loading, filteredData, handleSearch } = useContext(AlbumDataContext);
          ...
          />
              <Row>
                ...
                filteredData.map((val,i)=>{
                  return(
                    <Col md="4" key={i}><AlbumCardComponent item={val} /></Col>
